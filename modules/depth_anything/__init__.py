...
from modules.depth_anything.util import HWC3, common_input_validate, resize_image_with_pad, custom_hf_download, DEPTH_ANYTHING_MODEL_NAME
from modules.depth_anything.depth_anything.dpt import DPT_DINOv2
from modules.depth_anything.depth_anything.util.transform import Resize, NormalizeImage, PrepareForNet
...
class DepthAnythingDetector:
    ...
    def from_pretrained(cls, pretrained_model_or_path=DEPTH_ANYTHING_MODEL_NAME, filename="depth_anything_vitl14.pth"):
        ...
        model = DPT_DINOv2(**DPT_CONFIGS[ "depth_anything_vitl14.pth"], localhub=True)
